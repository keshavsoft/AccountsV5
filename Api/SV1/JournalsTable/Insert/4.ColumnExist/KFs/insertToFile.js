...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {AccountName : LocalCoumnAccountName,Date : LocalCoumnDate,Description : LocalCoumnDescription,Credit : LocalCoumnCredit,Debit : LocalCoumnDebit};
